...
const  App = ()=> {
  ...
  const [updateIndex, setIndexIndex] = useState(null)
  ...
  return (
    ...
    >
      ...
      />
      <View style={[tw`mt-2`,{flexDirection:'row' ,justifyContent:'space-between',width:todo.length > 0?'100%':null}]}>
      <Btn
